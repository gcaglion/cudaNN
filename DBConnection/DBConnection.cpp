...
//=== sDBConnection
sDBConnection::sDBConnection(char* objName_, s0* objParent_, char* username, char* password, char* connstring, sDebuggerParms* dbgparms_) : s0(objName_, objParent_, dbgparms_) {
...
sDBConnection::sDBConnection(char* objName_, s0* objParent_, tParmsSource* parms, char* parmKey, sDebuggerParms* dbgparms_) : s0(objName_, objParent_, dbgparms_) {
